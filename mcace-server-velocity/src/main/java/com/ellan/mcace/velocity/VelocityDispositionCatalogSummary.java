...
final class VelocityDispositionCatalogSummary {
    private VelocityDispositionCatalogSummary() {
    }
    ...
    static String failure(Optional<Long> activeSequence, VelocityAdmissionConfig.Mode mode) {
