...
| exact-commit CI/release | [push 运行 `32798326193`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798326193) 与 [PR 运行 `32798329912`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798329912) 对精确源码 `63ae400adc8d09d8349ca599c9d6a4866a189d04` 通过：build/test、本地验证包和 exact-eight 上传通过；受保护分支/tag 的 releaseBundle 与 readiness 只在 `main`/`v0.0.1` ref 执行。见[脱敏证据](docs/evidence/github-feature-ci-2026-08-25-63ae400.json) | 当前 feature 见证通过；仍待受保护分支/tag 的 exact-commit release |
