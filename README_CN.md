...
· [最新 feature 精确提交 CI 证据](docs/evidence/github-feature-ci-2026-08-25-63ae400.json)
· [当前 Helio 精确源码发布包证据](docs/evidence/release-bundle-2026-08-25-63ae400.json)
· [当前 fail-closed readiness 报告](docs/evidence/release-readiness-2026-08-25-030f038.json)
...
| exact-commit CI/release | [push 运行 `32798326193`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798326193) 与 [PR 运行 `32798329912`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798329912) 对精确源码 `63ae400adc8d09d8349ca599c9d6a4866a189d04` 通过：build/test、本地验证包和 exact-eight 上传通过；feature 分支按设计跳过 releaseBundle 与仅 main 执行的 readiness gate。见[脱敏证据](docs/evidence/github-feature-ci-2026-08-25-63ae400.json) | 当前 feature 见证通过；仍待受保护 main 的 exact-commit releaseBundle |
...
| 当前 release readiness | [`release-readiness-2026-08-25-030f038.json`](docs/evidence/release-readiness-2026-08-25-030f038.json) 由 fail-closed 门针对源码 `030f038…` 生成；服务器矩阵和 clean-worktree 通过，feature Helio 发布候选明确标记 `protected_main_exact_commit_ci=false`，因此受保护 main 发布包门仍关闭 | BLOCKED：三版本 GUI 六次同意、federation handoff、Vulcan genuine event、生产 authority freeze、受保护 main exact-commit 发布包仍未完成；没有宣称 tag 或 release |

最新保留的 feature exact-commit CI 证据绑定到
`63ae400adc8d09d8349ca599c9d6a4866a189d04`；当前 Helio 服务端矩阵证据独立绑定到
`65731aad2e023473a6a5f971404b86926603a0c0`。当前 HEAD 是
`63ae400…`，属于 provenance 门允许的文档/证据后代。
