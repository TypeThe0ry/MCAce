...
· [当前 fail-closed readiness 报告](docs/evidence/release-readiness-2026-08-25-785d443.json)
...
| 当前 release readiness | [`release-readiness-2026-08-25-785d443.json`](docs/evidence/release-readiness-2026-08-25-785d443.json) 由 fail-closed 门针对源码 `785d443…` 生成，记录矩阵、发布包与 clean-worktree 已通过以及 4 个未关闭的外部发布门 | BLOCKED：4 个外部发布门仍未关闭；没有宣称 tag 或 release |
