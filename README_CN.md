...
| 当前提交回归套件 | [473ef5b 回归证据](docs/evidence/static-regression-2026-08-24-473ef5b.json) 与 Helio wrapper 记录保留为历史见证；当前 feature HEAD 为 `540e4f2…`，可恢复服务端矩阵静态测试和 Helio 执行绑定在此前的代码提交 `0498ed2…` | 已记录检查通过；受保护 main 发布 CI 仍待完成 |
...
`27bb101d68bd0fcbc8891020951f28a523105038`；当前 Helio 服务端矩阵证据独立绑定到
