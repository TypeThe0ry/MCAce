...
· [当前 fail-closed readiness 报告](docs/evidence/release-readiness-2026-08-25-63ae400.json)
...
| 当前 release readiness | [`release-readiness-2026-08-25-63ae400.json`](docs/evidence/release-readiness-2026-08-25-63ae400.json) 由 fail-closed 门针对源码 `63ae400…` 生成，记录矩阵与 clean-worktree 已通过以及 5 个未关闭的外部/受保护发布门 | BLOCKED：5 个外部/受保护发布门仍未关闭；没有宣称 tag 或 release |
