...
final class ExplicitFileConsentController {
    ...
    void accept(MinecraftClient client, VerifiedPolicy policy, Set<String> requestedFiles,
        ...
        Pending next = new Pending(Set.copyOf(files), allowed, declined, client.currentScreen);
        pending = next;
        client.setScreen(new ExplicitFileConsentScreen(
