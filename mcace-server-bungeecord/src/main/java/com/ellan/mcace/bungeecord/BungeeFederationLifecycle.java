...
final class BungeeFederationLifecycle implements AutoCloseable {
    ...
    private BungeeFederationLifecycle(
    ...
    static BungeeFederationLifecycle load(
    ...
    static BungeeFederationLifecycle loadOrDisabled(
            Path dataDirectory, Clock clock, SecureRandom random, KeyPair persistedIdentity,
