...
| GitHub Actions / exact commit | Passed for current feature HEAD; protected-main release path pending | Push [`32656909125`](https://github.com/TypeThe0ry/MCAce/actions/runs/32656909125) and PR [`32656911462`](https://github.com/TypeThe0ry/MCAce/actions/runs/32656911462) both passed for exact source `4fb9c8b072e55d116e4b678a33048857c70ae686`; build/test and local-verification bundle passed, while releaseBundle was correctly skipped on the feature branch. | Feature SHA is CI-green. Merge to protected `main`, rerun exact-commit CI/releaseBundle, and verify the eight-file artifact before tagging. |
