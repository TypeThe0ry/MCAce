...
| Current-head regression suite | Passed 15/15 locally; targeted post-fix server-matrix and preparer gates passed on Helio; exact-checkout GitHub run [`32611684113`](https://github.com/TypeThe0ry/MCAce/actions/runs/32611684113) passed for `eb362296213838ab307fec9d9ea184eebb244a71` | [`static-regression-2026-08-23.json`](evidence/static-regression-2026-08-23.json) records the script hashes and bounded worker evidence. This closes the culture-stable timestamp regression only; it does not close GUI, Vulcan, federation, or production topology gates. |
