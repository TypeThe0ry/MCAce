...
| Current fail-closed readiness | Blocked for feature source `785d443ec026ec6b522e919252ed83aa559553f5` | [`release-readiness-2026-08-25-785d443.json`](evidence/release-readiness-2026-08-25-785d443.json) records the latest complete fail-closed evaluation: server matrix, current-source release bundle, and clean worktree passed; GUI six decisions, federation handoff, licensed Vulcan genuine event, and production authority freeze remain false. Later documentation-only descendants are provenance-accepted. | No tag/release claim is valid while any named blocker remains open. Rerun `scripts/release-readiness.ps1` after every evidence change. |
