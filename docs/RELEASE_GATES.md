...
| GitHub Actions / exact commit | Passed for recorded immutable commits; current HEAD CI pending | Runs [`32565146051`](https://github.com/TypeThe0ry/MCAce/actions/runs/32565146051) and [`32570987482`](https://github.com/TypeThe0ry/MCAce/actions/runs/32570987482) passed for their immutable source commits. The current e7f6f74 compatibility fix has not yet received a protected-main exact-commit run. | Historical exact-commit gates are green; current HEAD must receive its own required `build`/release run before tagging. |
