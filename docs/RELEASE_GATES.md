...
| Current fail-closed readiness | Blocked for feature source `63ae400adc8d09d8349ca599c9d6a4866a189d04` | [`release-readiness-2026-08-25-63ae400.json`](evidence/release-readiness-2026-08-25-63ae400.json) records the latest complete fail-closed evaluation: server matrix and clean worktree passed; Later documentation-only descendants are provenance-accepted. GUI six decisions, federation handoff, licensed Vulcan genuine event, production authority freeze, and protected exact release bundle remain false. | No tag/release claim is valid while any named blocker remains open. Rerun `scripts/release-readiness.ps1` after every evidence change. |
