...
| Current HEAD Helio static wrappers | Passed 14/14 | [`cluster-helio-cc91c63-static-2026-08-23.json`](evidence/cluster-helio-cc91c63-static-2026-08-23.json) records all 14 wrapper exit codes as zero on exact source `cc91c632…`. | Static wrappers are green; visible human consent, real federation, licensed Vulcan runtime, and production authority topology remain separate gates. |
