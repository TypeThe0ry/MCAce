...
| GitHub Actions / exact commit | Passed for current feature HEAD; protected-main release path pending | Push [`32650770008`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650770008) and PR [`32650767358`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650767358) both passed for exact source `614eda9776f63f38ec62421c7f9f80c28b24a1e4`. The workflow correctly produced the feature-branch local-verification path; the exact `releaseBundle` path is intentionally restricted to a protected `main` push. | Feature SHA is CI-green. Merge to protected `main`, rerun exact-commit CI/releaseBundle, and verify the eight-file artifact before tagging. |
...
| Current-head regression suite | Passed 15/15 locally plus current-source matrix and Helio Gradle verification | [`static-regression-2026-08-23-current.json`](evidence/static-regression-2026-08-23-current.json) records the wrapper hashes; [`cluster-helio-219e146-gradle-test-2026-08-23.json`](evidence/cluster-helio-219e146-gradle-test-2026-08-23.json) records the independent Helio checkout. GitHub push [`32650770008`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650770008) and PR [`32650767358`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650767358) passed for exact source `614eda9…`. GUI, Vulcan, federation, production topology, and protected-main release gates remain open. |
