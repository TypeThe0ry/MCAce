...
| GitHub Actions / exact commit | Passed for current feature HEAD; protected-main release path pending | Push [`32655439664`](https://github.com/TypeThe0ry/MCAce/actions/runs/32655439664) and PR [`32655441571`](https://github.com/TypeThe0ry/MCAce/actions/runs/32655441571) both passed for exact source `18ccbb816e9292213f033fc08bb83104dcfaca71`; build/test and local-verification bundle passed, while releaseBundle was correctly skipped on the feature branch. | Feature SHA is CI-green. Merge to protected `main`, rerun exact-commit CI/releaseBundle, and verify the eight-file artifact before tagging. |
