...
| Paper/Folia × Velocity/Bungee version process matrix | **PASSED — Matrix V4 external-supervisor evidence** | The current-source Helio run records 12/12 real cases (10 STABLE + 2 BETA), all startup/login/MCAce hello/auth/backend-admission checks passed, and cleanup zero. A D-drive out-of-band RSA supervisor signed the fresh request; Helio verified the detached receipt and the local publisher emitted the [release-eligible Matrix V4 index](evidence/server-version-process-matrix-20260906-3590b9f-20260906t0924461886559z.json). The receipt is `test_fixture=false` and binds source/artifact `3590b9f7aed34445a743282a0502a0a275347e34`, trust-root SHA-256 `05be3d1ce14b03ab66db85045377f52afa91f03d662a4d70c26468a93bcde223`, and receipt SHA-256 `9f617378ab6f937a4e52069a48c8163e933cc0386f47fd8511c1cea53a97c5b3`. | [Matrix V4](SERVER_VERSION_MATRIX_EVIDENCE_V4.md) is the first release-capable contract. The publisher revalidated exactly twelve raw reports, case/process incarnations and exit/cleanup, ordered raw hashes, source/artifact commits, all six release JARs, the three server JARs, an exact protected V4 bundle, and the externally signed receipt under the out-of-band approved pin. Paper 26.2 build 116 is STABLE; Folia 26.2 build 6 remains the two-case BETA lane. Online-mode/public-network behavior is not claimed. |
