...
| GitHub Actions / exact commit | Passed for canonical main commit `22288f60d61d39d169a5b7f1552e21e8514fa9c9` | Run [`32562226250`](https://github.com/TypeThe0ry/MCAce/actions/runs/32562226250) passed in 7m27s. It verified the exact checkout, ran build/test, built `releaseBundle`, uploaded the eight-file bundle, and produced `release_identity=true` with `source_commit=22288f60d61d39d169a5b7f1552e21e8514fa9c9`; local SHA256 verification passed. | This gate is green for the recorded immutable commit. Any later source commit must receive its own canonical main run before tagging. |
