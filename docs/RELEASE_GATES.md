...
| GitHub Actions / exact commit | Passed for feature source `b258d1b78f0aaa26388883427ca99f86ea52d1c2`; protected-main release path pending | [Push run `32797593897`](https://github.com/TypeThe0ry/MCAce/actions/runs/32797593897) and [PR run `32797597164`](https://github.com/TypeThe0ry/MCAce/actions/runs/32797597164), with sanitized [evidence](evidence/github-feature-ci-2026-08-25-b258d1b.json), passed exact checkout, build/test, local-verification bundle, and exact-eight upload; releaseBundle and the main-only readiness gate were correctly skipped on the feature branch. | Current feature witness is green. Merge to protected `main` only after external gates close, then rerun exact-commit CI/releaseBundle and verify the eight-file artifact before tagging. |
| Current fail-closed readiness | Blocked for feature source `b258d1b78f0aaa26388883427ca99f86ea52d1c2` | [`release-readiness-2026-08-25-b258d1b.json`](evidence/release-readiness-2026-08-25-b258d1b.json) records the latest complete fail-closed evaluation: server matrix and clean worktree passed; Later documentation-only descendants are provenance-accepted. GUI six decisions, federation handoff, licensed Vulcan genuine event, production authority freeze, and protected exact release bundle remain false. | No tag/release claim is valid while any named blocker remains open. Rerun `scripts/release-readiness.ps1` after every evidence change. |
