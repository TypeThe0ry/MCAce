...
| Current main exact-commit CI / release bundle | Passed for `50362a15f218b035bbbc98749ee09a22f6e059e3` | Run [`32569343606`](https://github.com/TypeThe0ry/MCAce/actions/runs/32569343606) verified the exact checkout, ran build/test, built the exact release candidate, uploaded all eight entries, and passed local SHA256 verification. See [`release-bundle-2026-08-22-50362.json`](evidence/release-bundle-2026-08-22-50362.json). | Current source is green. This evidence commit itself still needs a required `build` check before it can become the release source. |
