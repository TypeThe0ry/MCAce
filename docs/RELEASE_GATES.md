...
| Current-head regression suite | Passed 15/15 locally; targeted post-fix server-matrix and preparer gates passed on Helio source-equivalent checkout; exact-checkout GitHub push run [`32615228461`](https://github.com/TypeThe0ry/MCAce/actions/runs/32615228461) and PR run [`32615229811`](https://github.com/TypeThe0ry/MCAce/actions/runs/32615229811) passed for current HEAD `83d9d2e…` | [`static-regression-2026-08-23-current.json`](evidence/static-regression-2026-08-23-current.json) records the script hashes and bounded worker evidence. The source-bound evidence is retained as evidence of the timestamp regression; GUI, Vulcan, federation, and production topology gates remain open. |
...
| SERVER_CONFIRMED producer | Grim real-process path passed; production freeze pending | [`rerun-2026-08-23.json`](evidence/real-server-2026-08-23/rerun-2026-08-23.json) proves a repeat real Grim provider and real Paper process reached the MCAce `SERVER_CONFIRMED` channel three times from the current HEAD `d05f98c…` plugin artifact. The default-disabled codec/registry/journal/coordinator foundation remains unit-tested. | Provider/profile/key/topology freeze and the genuine licensed Vulcan producer are still pending; loopback evidence is not a production Cloud claim. |
