...
| GitHub Actions / exact commit | Passed for feature source `7badb753c74db73a0831bdfe9c0c929964407a53`; protected-main release path pending | [Run `32751838730`](https://github.com/TypeThe0ry/MCAce/actions/runs/32751838730) and its sanitized [evidence](evidence/github-feature-ci-2026-08-25-7badb75.json) passed exact checkout, build/test, local-verification bundle, and exact-eight upload; releaseBundle was correctly skipped on the feature branch. | Feature witness is green. Merge to protected `main`, rerun exact-commit CI/releaseBundle, and verify the eight-file artifact before tagging. |
