...
the Helio Execute+ReportOnly record bound to code commit `0498ed2…` (see
`evidence/server-version-process-matrix-2026-08-25-0498ed2.json`). Separately, all three Fabric clients now
