...
| Exact-commit CI/release | Push [`32615615400`](https://github.com/TypeThe0ry/MCAce/actions/runs/32615615400) and PR [`32615617012`](https://github.com/TypeThe0ry/MCAce/actions/runs/32615617012) passed for immutable current HEAD `27bb101d68bd0fcbc8891020951f28a523105038`; build/test and local verification bundle passed, while the release candidate is intentionally skipped off `main` | PASS for this feature commit; protected `main` release CI and the clean exact-commit release bundle remain pending |

The latest exact-commit CI evidence is bound to
`27bb101d68bd0fcbc8891020951f28a523105038` shown above. Verify any checkout with `git rev-parse HEAD`; do not copy an
