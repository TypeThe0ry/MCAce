...
| Current-head regression suite | [473ef5b evidence](docs/evidence/static-regression-2026-08-24-473ef5b.json) and the Helio wrapper records remain retained as historical witnesses; the current feature HEAD is `540e4f2…`, while the resumable server-matrix static test and Helio execution are bound to the preceding code commit `0498ed2…` | PASS for the recorded checks; fresh protected-main release CI is still pending |
...
`27bb101d68bd0fcbc8891020951f28a523105038`; the current Helio server-matrix
