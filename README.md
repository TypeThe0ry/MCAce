...
· [current fail-closed readiness report](docs/evidence/release-readiness-2026-08-25-030f038.json)
...
| Exact-commit CI/release | [Push run `32798326193`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798326193) and [PR run `32798329912`](https://github.com/TypeThe0ry/MCAce/actions/runs/32798329912) passed for exact source `63ae400adc8d09d8349ca599c9d6a4866a189d04`: build/test, local verification bundle, and exact-eight upload passed; releaseBundle and the main-only readiness gate were correctly skipped on the feature branch. See [sanitized evidence](docs/evidence/github-feature-ci-2026-08-25-63ae400.json). | PASS for the current feature witness; protected-main exact-commit releaseBundle remains pending |
...
| Current release readiness | [`release-readiness-2026-08-25-030f038.json`](docs/evidence/release-readiness-2026-08-25-030f038.json) is generated by the fail-closed gate against source `030f038…`; server-matrix and clean-worktree pass, while the feature Helio bundle remains explicitly `protected_main_exact_commit_ci=false` and the protected-main bundle gate stays closed | BLOCKED: GUI six decisions, federation handoff, Vulcan genuine event, production authority freeze, and protected-main exact-commit bundle remain open; no tag or release is claimed |
