...
| Current release readiness | [`release-readiness-2026-08-25-1beccc7.json`](docs/evidence/release-readiness-2026-08-25-1beccc7.json) is generated by the fail-closed gate against the current documentation/evidence-only descendant | BLOCKED: 5 named external/protected gates remain open; no tag or release is claimed |
