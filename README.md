...
| Latest recorded exact-commit CI/release | Run [`32570987482`](https://github.com/TypeThe0ry/MCAce/actions/runs/32570987482) passed for merged source `f355a85f65173c6e98ab685e3b36f5e172b85498`; [bundle evidence](docs/evidence/release-bundle-2026-08-22-f355a85.json) records `release_identity=true` and a verified exact-eight SHA256 set | PASS for that immutable source; any later commit needs its own required `build` check before tagging |
