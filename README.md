...
· [latest feature exact-commit CI evidence](docs/evidence/github-feature-ci-2026-08-25-b258d1b.json)
· [current fail-closed readiness report](docs/evidence/release-readiness-2026-08-25-b258d1b.json)
...
| Exact-commit CI/release | [Push run `32797593897`](https://github.com/TypeThe0ry/MCAce/actions/runs/32797593897) and [PR run `32797597164`](https://github.com/TypeThe0ry/MCAce/actions/runs/32797597164) passed for exact source `b258d1b78f0aaa26388883427ca99f86ea52d1c2`: build/test, local verification bundle, and exact-eight upload passed; releaseBundle and the main-only readiness gate were correctly skipped on the feature branch. See [sanitized evidence](docs/evidence/github-feature-ci-2026-08-25-b258d1b.json). | PASS for the current feature witness; protected-main exact-commit releaseBundle remains pending |
...
| Current release readiness | [`release-readiness-2026-08-25-b258d1b.json`](docs/evidence/release-readiness-2026-08-25-b258d1b.json) is generated by the fail-closed gate against source `b258d1b…`; it records the matrix and clean-worktree passes plus the five unresolved external/protected gates | BLOCKED: 5 named external/protected gates remain open; no tag or release is claimed |

The latest retained feature exact-commit CI evidence is bound to
`b258d1b78f0aaa26388883427ca99f86ea52d1c2`; the current Helio server-matrix
