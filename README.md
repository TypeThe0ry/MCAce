...
· [current fail-closed readiness report](docs/evidence/release-readiness-2026-08-25-785d443.json)
...
| Current release readiness | [`release-readiness-2026-08-25-785d443.json`](docs/evidence/release-readiness-2026-08-25-785d443.json) is generated by the fail-closed gate against source `785d443…`; it records the matrix, release-bundle, and clean-worktree passes plus the four unresolved external gates | BLOCKED: 4 named external gates remain open; no tag or release is claimed |
