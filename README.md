...
| Current-head regression suite | [current-head regression evidence](docs/evidence/static-regression-2026-08-23-current.json): all 15 wrappers passed locally; current HEAD matrix/preparer gates passed; Helio ran an independent Gradle `test` checkout; GitHub push run [`32650770008`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650770008) and PR run [`32650767358`](https://github.com/TypeThe0ry/MCAce/actions/runs/32650767358) passed for exact source `614eda9…` | PASS for current feature HEAD; protected-main release path still pending |
