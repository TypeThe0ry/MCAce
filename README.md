...
`27bb101d68bd0fcbc8891020951f28a523105038` shown above. Verify the source commit used for the evidence with `git rev-parse HEAD`; later documentation-only commits do not change the tested plugin artifact. Do not copy an
