...
· [latest feature exact-commit CI evidence](docs/evidence/github-feature-ci-2026-08-25-5d15c6a.json)
· [current fail-closed readiness report](docs/evidence/release-readiness-2026-08-25-d8fe360.json)
...
| Exact-commit CI/release | [Push run `32796860076`](https://github.com/TypeThe0ry/MCAce/actions/runs/32796860076) and [PR run `32796863559`](https://github.com/TypeThe0ry/MCAce/actions/runs/32796863559) passed for exact source `5d15c6a7c7593df783b239d9b902c1ebde449472`: build/test, local verification bundle, and exact-eight upload passed; releaseBundle and the main-only readiness gate were correctly skipped on the feature branch. See [sanitized evidence](docs/evidence/github-feature-ci-2026-08-25-5d15c6a.json). | PASS for the current feature witness; protected-main exact-commit releaseBundle remains pending |
...
| Current release readiness | [`release-readiness-2026-08-25-d8fe360.json`](docs/evidence/release-readiness-2026-08-25-d8fe360.json) is generated by the fail-closed gate against current source `d8fe360…`; it records the matrix and clean-worktree passes plus the five unresolved external/protected gates | BLOCKED: 5 named external/protected gates remain open; no tag or release is claimed |

The latest retained feature exact-commit CI evidence is bound to
`5d15c6a7c7593df783b239d9b902c1ebde449472`; the current Helio server-matrix
